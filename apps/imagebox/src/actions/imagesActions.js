import { ADD_IMAGES, UPDATE_IMAGEID, UPDATE_PERCENT, UPLOAD_COMPLETE, UPDATE_FIELDS, CLEAR_IMAGES, DELETE_IMAGE, RETRY_IMAGE, ERROR_TO_FIRST,SORT_IMAGE, DELETE_UPLOADED_IMAGE, UPDATE_IMAGE_USED_COUNT } from '../contants/actionTypes';
...
export function addImages(files) {
  return (dispatch, getState) => {
    ...
    uploadFiles(getImageIdsUrl,uploadImagesUrl,files,dispatch,env,uploading);
  }
}
...
export function retryImage(imageId){
  return (dispatch, getState) => {
    ...
    uploadFiles(getImageIdsUrl,uploadImagesUrl,[uploading[index].file],dispatch,env,uploading,true,index);
  }
}
// /**
 ...
 * @returns {function(*)}
 */
function uploadFiles(getImgIdsUrl,uploadImagesUrl,files,dispatch,env,uploadedImages,isRetry,index){
